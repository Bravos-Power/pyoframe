...
- **Improved documentation** including a revamped [API page](../../reference/index.md) and new explanations of functions like [`.over(…)`](../concepts/special-functions.md#adding-expressions-with-differing-dimensions-using-over).
...
Steps 1 to 3 should cover 99% of cases. 
Below are some additional breaking changes that you are unlikely to encounter in practice.
